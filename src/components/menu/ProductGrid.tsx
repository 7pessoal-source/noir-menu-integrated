...
import { PRODUCTS as FALLBACK_PRODUCTS } from "@/config/menuConfig";
...
export function ProductGrid({ selectedCategory, onAddProduct, products }: ProductGridProps) {
  const productsToUse = products || FALLBACK_PRODUCTS;
  
  const filteredProducts =
    selectedCategory === "all"
      ? productsToUse
      : productsToUse.filter((p) => p.category === selectedCategory);
