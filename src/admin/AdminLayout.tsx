...
import { LayoutDashboard, Tag, Package, Settings, LogOut, Menu, Eye } from 'lucide-react';
    ...
    <div className="flex flex-col md:flex-row min-h-screen bg-zinc-950 text-zinc-100">
      ...
      `}>
        ...
        <nav className="flex-1 px-4 py-4 space-y-2 overflow-y-auto">
          ...
          {/* Botão para ver o cardápio */}
          <a
            href="/"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-3 px-4 py-3 rounded-lg transition-colors font-medium text-emerald-400 hover:bg-emerald-500/10"
          >
