/* =============================================================================
   ...
   ⚠️ ATENÇÃO: Este arquivo agora serve como FALLBACK!
   
   Os dados principais vêm do SANITY CMS. Estes valores abaixo só serão usados:
   - Durante o desenvolvimento (se o Sanity não estiver configurado)
   - Como backup em caso de erro ao buscar do Sanity
   
   Para editar o cardápio de produção:
   1. Acesse o Sanity Studio: https://[seu-projeto].sanity.studio
   2. Faça as alterações lá (produtos, preços, fotos, etc)
